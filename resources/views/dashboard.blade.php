    ...
    <div class="vz_main_content">
                        ...
                        <div class="d-flex col-md-6 col-lg-3 align-items-center">
                            <div class="card-body">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col">
                                        <h6 class="mb-0 text-muted">Active <span class="text-primary">Projects</span></h6>
                                        <h4 class="mt-3 mb-0">6834</h4>
                                    </div>
                                </div>
                                <p class="mb-0 text-muted">63% From Last Month</p>
                            </div>
                        </div>
                        <div class="d-flex col-md-6 col-lg-3 align-items-center">
                            <div class="card-body">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col">
                                        <h6 class="mb-0 text-muted"><span class="text-primary">Total</span> Orders</h6>
                                        <h4 class="mt-3 mb-0">8263</h4>
                                    </div>
                                </div>
                                <p class="mb-0 text-muted">70% From Last Month</p>
                            </div>
                        </div>
                        <div class="d-flex col-md-6 col-lg-3 align-items-center">
                            <div class="card-body">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col">
                                        <h6 class="mb-0 text-muted">New <span class="text-primary">Visitors</span></h6>
                        ...
                        <div class="d-flex col-md-6 col-lg-3 align-items-center">
                            <div class="card-body">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col">
                                        <h6 class="mb-0 text-muted">Total <span class="text-primary">Earnings</span></h6>
                                        <h4 class="mt-3 mb-0">3682</h4>
                                    </div>
                                </div>
                                <p class="mb-0 text-muted">89% From Last Month</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mt-4 stretched_card">
                <div class="card">
                    <div class="card-body">
                        <div class="card_title d-flex flex-wrap justify-content-between align-items-center">
                            <div>
                                <h4 class="card_title mb-0">User Visits</h4>
                            </div>
                            <div>
                                <div class="d-flex align-items-center">
                                    <div class="mr-2 d-none d-md-block tab_links">
            ...
            <div class="col-lg-6 mt-4 stretched_card">
                <div class="card">
                    <div class="card-body">
                        <div class="card_title d-flex flex-wrap justify-content-between align-items-center">
                            <div>
                                <h4 class="card_title mb-0">Sales Stats</h4>
                            </div>
                            <div>
                                <div class="d-flex align-items-center">
                                    <div class="mr-2 d-none d-md-block tab_links">
                        ...
                        <div class="bullet_wrap_chart text-center mt-3">
                            <div class="bullet_chart">
                                <span class="circle_chart circle_light_chart"></span><span>Weekly (15.12%)</span>
                            </div>
                            <div class="bullet_chart">
                                <span class="circle_chart"></span><span>Monthly (3.20%)</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 mt-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card_title">Products Table</h4>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text-left">
                                                ...
                                                <div class="text-dark">23 June 2019</div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><button type="button" class="btn btn-inverse-secondary"><i class="fa fa-edit"></i></button></li>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text-left">
                                                ...
                                                <div class="text-dark">15 July 2019</div>
                                            </div>
                                        </td>
                                        <td>Jeffery M. Jensen</td>
                                        <td>Samsung C7 Pro</td>
                                        <td>24-08-2019</td>
                                        <td>700.00$</td>
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text-left">
                                                ...
                                                <div class="text-dark">12 Aug 2019</div>
                                            </div>
                                        </td>
                                        <td>Adam L. Easter</td>
                                        <td>Lg G6</td>
