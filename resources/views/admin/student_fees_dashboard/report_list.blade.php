                    ...
                    <div class="card-body">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    ...
                                    <h4 class="page-title">{{  ucwords($menuNames['student_fees_dashboard_create_' . $company_id] ?? $title )}}</h4>
                                </div>
                        ...
                        <form class="mb-15" id="kt_course_delete" action="{{ route('admission.delete') }}" method="POST">
                            ...
                            <table id="common_datatable" class="table table-striped w-100"
                                data-column="id,student_name,mobile,due_date,pending_payment{{ auth()->user()->role == 'super-admin' ? ',company_name' : '' }},created_by,created_at"
                                data-column-name="id,student_name,mobile,due_date,pending_payment{{ auth()->user()->role == 'super-admin' ? ',company_name' : '' }},created_by,created_at,actions"
                                ...
                                data-control="{{ route('student-fees-dashboard.list') }}" data-sorting="3" data-sorting-type="DESC"
