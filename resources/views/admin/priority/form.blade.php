        ...
        <div class="vz_main_content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card_title">{{ ucwords('Add '.$menuNames['priority_' . $company_id] ??  $title )}}</h4>
                            <form id="priority_form"
                                action="{{ isset($priority) ? route('priority.update', $priority->id) : route('priority.store') }}"
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Priority Name: <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Name" required value="{{ old('name', $priority->name ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="company_id" name="company_id" class="form-select datatable-input"  {{ isset($priority->company_id) ? 'disabled' : '' }}
                                            required>
                                            <option value="">- Select Company -</option>
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}"
                                                    {{ old('company_id', $priority->company_id ?? '') == $company->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="sequence_number" name="sequence_number"
                                            placeholder="Sequence Number" required value="{{ old('sequence_number', $priority->sequence_number ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="customSwitch1" name="status" value="1"
                                                {{ old('status', $priority->status ?? 1) == 1 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorPrimary" name="color" value="badge-primary"
                                                    {{ old('color', $priority->color ?? '') == 'badge-primary' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorSecondary" name="color" value="badge-secondary"
                                                    {{ old('color', $priority->color ?? '') == 'badge-secondary' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorSuccess" name="color" value="badge-success"
                                                    {{ old('color', $priority->color ?? '') == 'badge-success' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorDanger" name="color" value="badge-danger"
                                                    {{ old('color', $priority->color ?? '') == 'badge-danger' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorInfo" name="color" value="badge-info"
                                                    {{ old('color', $priority->color ?? '') == 'badge-info' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorLight" name="color" value="badge-light"
                                                    {{ old('color', $priority->color ?? '') == 'badge-light' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-2">
                                                <input type="radio" class="form-check-input" id="colorDark" name="color" value="badge-dark"
                                                    {{ old('color', $priority->color ?? '') == 'badge-dark' ? 'checked' : '' }}>
