   ...
   <header class="vz_main_header flex-grow-1 top_nav">
      <div class="container-fluid d-flex flex-row h-100 align-items-center">
          ...
          <div class="text-center rt_nav_wrapper d-flex align-items-center">
              <a class="nav_logo rt_logo" href="index.html"><img src="{{ asset('assets/images/logo-dark.svg') }}" alt="logo"/></a>
              <a class="nav_logo nav_logo_mob" href="index.html"><img src="{{ asset('assets/images/mobile-logo.svg') }}" alt="logo"/></a>
                  ...
                  *====================================-->
                  <li class="nav-item nav-profile dropdown">
                      <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                          <span class="profile_sec">
                              ...
                              <span class="profile_name">
                                  ...
                                  {{ $company->company_name }}. <i class="feather ft-chevron-down"></i>
                                  @endif
                                  @else

                                  {{ Auth::user() ? Auth::user()->name : 'Guest' }}. <i class="feather ft-chevron-down"></i>
                                  @endif
                              </span>
                              @if(Auth::user()->role == 'admin')
                              @if($company = App\Models\Company::where('user_id', Auth::user()->id)->first())
                              <img src="{{ asset('storage/' . ($company->photo ?? 'default.jpg')) }}" alt="Company Image" style="object-fit: contain;"/>
                              @endif
                              @else
                              <img src="{{ Auth::user() && Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('assets/images/user.jpg') }}" style="object-fit: contain;" alt="profile"/>
                              @endif
                            </span>
                      </a>
                      <div class="dropdown-menu dropdown-menu-right navbar-dropdown pt-2"
                          ...
                          <a class="dropdown-item" href="{{ route('user-profile.index') }}#contacts">
