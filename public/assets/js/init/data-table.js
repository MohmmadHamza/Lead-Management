...
$(document).ready(function () {
            ...
            if (index == 0 && item == "id") {
                ...
                $columns_data.push({
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        $return_string +=
                            '<button class="btn p-0  hide-arrow" type="button" id="editDropdown${full.id}" data-bs-toggle="dropdown" aria-expanded="false"><i class="feather ft-more-vertical text-muted"></i></button>';
                        $return_string +=
    ...
    oTable = $("#common_datatable").DataTable({
        ...
        dom: "<'row'><'row'<'col-md-6'lB><'col-md-6'f>r>t<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
        // scrollX: true,
        language: {
            paginate: {
                previous: "Previous",
    ...
    if (conf) {
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                toastr.error(errorMessage,"Oh snap!!");
            },
        });
    }
}
